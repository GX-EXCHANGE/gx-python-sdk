from gx_exchange.api import API
from gx_exchange.utils.types import (
    Any,
    Callable,
    Cloid,
    List,
...
from gx_exchange.websocket_manager import WebsocketManager
...
class Info(API):
    ...
    def user_role(self, user: str) -> Any:
        ...
        Returns:
            ...
            permissions, and relationships within the GX Exchange ecosystem.
        """
